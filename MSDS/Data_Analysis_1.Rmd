...
***Answer: The distribution for class A1 and A2 both look to represent a normal distribution. Classes A3, A4 and A5 all look to represent a bimodal distribution.***
...
hist(female$RATIO, main = 'Female Ratios', col='turquoise')
hist(male$RATIO,main='Male Ratios', col='springgreen')
hist(infant$RATIO, main = 'Histogram of Infants', col='slategray')
...
***Answer: The female ratios closely resemble a normal distribution while the male and infant ratios show non-normality with a stronger positive skew. All sexes have outliers contributing to the non-normality.***
...
```{r Part_3b}
kable(subset(mydata, RATIO > (quantile(mydata$RATIO)[4] + 3*IQR(mydata$RATIO)), select = 1:10))
kable(subset(mydata, RATIO > (quantile(mydata$RATIO)[4] + 1.5*IQR(mydata$RATIO)), select = 1:10))
